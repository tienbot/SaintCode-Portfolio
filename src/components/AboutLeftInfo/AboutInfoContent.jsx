...
const AboutInfoContent = ({ activeToggle }) => {
  ...
  const experianceText = `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed non risus. Suspendisse lectus tortor, sit amet, adipiscing nec, ultricies sed, dolor. Cras elementum ultrices diam. Maecenas ligula massa, varius a, semper congue, euismod non, mi. Proin porttitor, orci nec nonummy molestie, enim est eleifend mi, non fermentum diam nisl sit amet erat.
  ...
  switch (activeToggle) {
    case 'Experiance':
      ...
      break;
    case 'Skills':
      leftContent = <div className={s.content}>Skills content</div>;
      break;
    case 'Certificates':
      leftContent = <div className={s.content}>
    ...
    case 'education':
      ...
      break;
    case 'Music':
      leftContent = <div className={s.content}>Music content</div>;
      break;
    case 'Hiking':
      leftContent = <div className={s.content}>Hiking content</div>;
      break;
    case 'Books':
      leftContent = <div className={s.content}>Books content</div>;
      break;
    case 'Test':
      leftContent = <div className={s.content}>Test111000111</div>;
      break;
    default:
      break;
  }
